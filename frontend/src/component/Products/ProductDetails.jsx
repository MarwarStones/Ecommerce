...
const ProductDetails = ({ match, history }) => {
  ...
  const addToCartHandler = () => {
    if (product.Stock > 0) {
      dispatch(addItemsToCart(match.params.id, quantity, user));
  ...
  const addToFavouriteHandler = () => {
    dispatch(addFavouriteItemsToCart(match.params.id, quantity, user));
    ...
    <>
      {loading ? (
        ...
        <>
              ...
              <div className="detailsBlock">
                ...
                >
                  ...
                  >
                    ...
                    <span
                      className="cartBtn"
                      style={{ opacity: 0.8, padding: "2px 8px" }}
                    >
                      Add to wishlist
                    </span>
                  </div>
          ...
          {/* Reviews */}
          <div className="reviews__heading" style={{backgroundColor:"#F5F5DD"}}>
            <h1
              style={{
                padding: "5px 30px",
                opacity: 1,
