    ...
    return (
        ...
        <div className='rules' style={{
            ...
            <ul className='rules'>
                ...
                <li>2. You have to give delivery charge first for cash on Delivery..In Jodhpur City you have to give 70/- and outside it charges will be 120/-</li>
                ...
                <li>5. You can find more new features in our business in very soon...Our developers team always work for your good services...</li>
